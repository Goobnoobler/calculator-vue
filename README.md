...
This frontend was completely generated by AI for the purpose of demonstrating my go backend. I also wanted to familirise myself with Vue so I got claude to teach me the difference between this and ember.js, which is what I use at my internship. I also used this as a live example to demonstrate to myself how playwright works.

I used a sandboxed microVM running claude to generate this. My setup utilises this repo https://github.com/wirenboard/agent-vm, which was listed in the community showcase from https://github.com/superradcompany/microsandbox .
